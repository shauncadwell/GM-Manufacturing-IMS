...
namespace GB_Manufacturing_IMS
{
    public partial class Intro : Form
    {
        ...
        {
            MessageBox.Show("This section is under construction and not not functioning completely.", "Section Not Available", MessageBoxButtons.OK, MessageBoxIcon.Information);
